...
<body>
    ...
    <ul class="forminfo">
    <li><label>课程编号</label><input name="course_id" type="text" class="dfinput" /><i></i></li>
    ...
    <li><label>学分数</label><input name="freq" type="text" class="dfinput" /><i></i></li>
       想在周几上课？<br />
       <input TYPE="checkbox" name="day1" VALUE="1"> 周一
       <input TYPE="checkbox" name="day2" VALUE="1"> 周二
       <input TYPE="checkbox" name="day3" VALUE="1"> 周三
       <input TYPE="checkbox" name="day4" VALUE="1"> 周四
       <input TYPE="checkbox" name="day5" VALUE="1"> 周五
        想在第几节上课？<br />
       <input TYPE="checkbox" name="c1" VALUE="1"> 第一节 8:00-9:35
       <input TYPE="checkbox" name="c2" VALUE="1"> 第二节 9:50-11:30
       <input TYPE="checkbox" name="c3" VALUE="1"> 第三节 13:30-15:05
       <input TYPE="checkbox" name="c4" VALUE="1"> 第四节 15:20-16:55
       <input TYPE="checkbox" name="c5" VALUE="1"> 第五节 17:10-18:45
         想在哪个楼的教室？<br />
       <div class="vocation">
