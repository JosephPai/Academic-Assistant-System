...
<body>
    ...
    <div class="itab">
  	<ul> 
  	<li><a href="#tab1" class="selected">已结束的SRTP项目</a></li> 
    ...
    <table class="tablelist">
        ...
        <%
        //查看所有待立项的项目并输出
        String sql = "SELECT i.id,i.srtp_name,s.name,i.teacher_name,i.publish_time FROM information AS i INNER JOIN student AS s WHERE i.leader_id = s.id AND i.status = 3";
        ...
        while(rs.next()){
        	...
        	StringBuffer sss = new StringBuffer("<td>"+"<a href=\"DetailedInformation4.jsp?id=");
        	sss.append(srtpid);
