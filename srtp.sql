...
) ENGINE=InnoDB AUTO_INCREMENT=201806031104 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ggg
-- ----------------------------
INSERT INTO `ggg` VALUES ('1', '41504675', '殷绪成', '软件工程课程设计', '开发一个本科教务秘书管理系统，用于教信息管理', '毕业设计1的任务书.docx', null, '中期报告', '最终论文', '2017-2018-02', '0', '开题报告', '开题报告反馈', '中期审查反馈', '最终论文反馈');
...
-- ----------------------------
INSERT INTO `information` VALUES ('1', '深度学习', '41504675', '殷绪成', '18-02', '校级', '深度学习的概念源于人工神经网络的研究。含多隐层的多层感知器就是一种深度学习结构。', '深度学习通过组合低层特征形成更加抽象的高层表示属性类别或特征', '3000', '41504676', '41504677', '3', '三国历史中期审查.pdf', '这会肯定对了！.docx');
...
INSERT INTO `student` VALUES ('41504677', '赵宇', '经管', '经济1501');
...
INSERT INTO `teachreserch` VALUES ('9', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '0', null, null, null);
...
INSERT INTO `textbook` VALUES ('2', 'Mysql从删库到跑路', '2018-06-06', 't0002', '新编', '1', '程序员素质养成', '1000', 't0001', 't0003', '大纲还不知道', '目的也不清楚', null, 'CNN中期审查.doc', '2', 'Mysql最终审查.pdf');
...
INSERT INTO `textbook` VALUES ('4', '111', '111', '', '111', '', '', '', '', '', '', '', null, null, '0', null);
INSERT INTO `textbook` VALUES ('5', '数学分析选讲II', '2018-06-07', 't0001', '新编', '不知道字数', '数学分析', '3000', 't0002', 't0003', '没有大纲', '漫无目的', null, null, '3', 'qwqwe.jpg');
...
INSERT INTO `textbook_fund` VALUES ('5', '100', '10', '0');
